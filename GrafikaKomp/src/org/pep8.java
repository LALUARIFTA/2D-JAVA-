 ...
 * @author ari
 */
public class pep8 extends JFrame {
    ...
    public void kumis(Graphics g) {
        g.fillRect(150, 520, 120, 10);   //kumis kanan 1
        g.fillRect(150, 540, 120, 10);   //kumis kanan 1
        g.fillRect(150, 560, 120, 10);   //kumis kanan 1

        g.fillRect(610, 520, 120, 10);   //kumis kanan 1
        g.fillRect(610, 540, 120, 10);   //kumis kanan 1
        g.fillRect(610, 560, 120, 10);   //kumis kanan 1
